...
- `npm run check` — the complete pull-request CI quality gate: size, unit and type tests (including compliance coverage), deterministic fuzz regression, and browser CSP. **There is no build step.**
